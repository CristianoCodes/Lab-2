...
6. Just like in the first lab, I didn't use AI. Although the AI Google search results were unavoidable and unable to be turned off, I tried to only use things like YouTube videos and Stack Overflow. When I was figuring out how to implement my methods to have separate outputs for an empty input and an input that wasn't an option, I was struggling super hard. With some Google searches, I was able to figure out how to implemente these features while still following the Liskov principle.